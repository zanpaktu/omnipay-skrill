...
class StatusClassCallbackTest extends \PHPUnit_Framework_TestCase
{
    public function testCalculateMd5Signature()
    {
        ...
        $callback->setSecretWord('random');
        
        $this->assertEquals(
            '5630F908E45A6CF04EC615B6A0DED988',
            $callback->calculateMd5Signature()
        );
    }

    public function testTestMdSignaturesEnabled()
    {
        $callback = new StatusCallback([
            'transaction_id'=> 'transaction',
            'mb_amount'=> '1',
        ...
        $this->assertFalse($callback->testMdSignatures());
    }

    public function testTestMdSignaturesDisabled()
    {
        $callback = new StatusCallback([
            'transaction_id'=> 'transaction',
            'mb_amount'=> '1',
        ...
        $callback->setMd5TestEnabled(false);
